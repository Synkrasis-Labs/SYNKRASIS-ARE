...
class CustomScenario(COREScenario):
    ...
    prompt: str | None = "Rename 'notes.txt' to 'new_notes.txt' and list all files."
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            oracle1 = (
                file_management_app.rename_file(
                    old_name="notes.txt", new_name="new_notes.txt"
                )
                .oracle()
                .depends_on(event1, delay_seconds=2)
            )
            oracle2 = (
                file_management_app.list_files()
                .oracle()
