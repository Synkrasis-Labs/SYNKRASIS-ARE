...
class CustomScenario(COREScenario):
    ...
    prompt: str | None = (
        "Show all users and update the email of the user with name 'Alice' to 'alice@example.com'. Finally verify the changes were applied."
    )
        ...
        with EventRegisterer.capture_mode():
            ...
            oracle2 = (
                crud_app.update_user_email(
                    user_id="Alice_id", email="alice@example.com"
                )
                .oracle()
