...
class CustomScenario(COREScenario):
    ...
    prompt: str | None = (
        "Conduct an audit on GDPR compliance and flag the issue: 'Data breaches not reported within 72 hours'"
    )
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            oracle1 = (
                legal_compliance_app.generate_audit_report(doc_name="gdpr_compliance")
                .oracle()
                .depends_on(event1, delay_seconds=2)
            )
            oracle2 = (
                legal_compliance_app.flag_violation(
                    issue="Data breaches not reported within 72 hours"
                )
                .oracle()
