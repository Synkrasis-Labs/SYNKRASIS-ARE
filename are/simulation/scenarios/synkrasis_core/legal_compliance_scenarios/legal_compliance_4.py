...
class CustomScenario(COREScenario):
    ...
    prompt: str | None = (
        "Enforce the terms of service compliance by checking data collection and setting privacy settings"
    )
        ...
        with EventRegisterer.capture_mode():
            ...
            oracle1 = (
                legal_compliance_app.check_compliance(
                    ...
                    statement="Users must not engage in fraudulent activities",
                )
                .oracle()
            ...
            oracle2 = (
                legal_compliance_app.enforce_compliance(
                    doc_name="terms_of_service", issue="Fraudulent activity detected"
                )
                .oracle()
