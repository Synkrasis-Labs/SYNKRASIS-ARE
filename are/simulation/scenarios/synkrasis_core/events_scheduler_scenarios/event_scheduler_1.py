...
class CustomScenario(COREScenario):
    ...
    prompt: str | None = (
        "Schedule a meeting called 'Team Sync' at '2025-02-10T09:00:00' and retrieve its scheduled time."
    )
        ...
        with EventRegisterer.capture_mode():
            ...
            oracle1 = (
                events_scheduler_app.schedule_event(
                    event_name="Team Sync", event_time="2025-02-10T09:00:00"
                )
                .oracle()
                .depends_on(event1, delay_seconds=2)
            )
            oracle2 = (
                events_scheduler_app.get_event_time(event_name="Team Sync")
                .oracle()
