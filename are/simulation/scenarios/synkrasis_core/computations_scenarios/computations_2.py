...
class CustomScenario(COREScenario):
    ...
    prompt: str | None = "Divide 100 by 4, then raise the result to the power of 2."
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            oracle1 = (
                computations_app.divide_numbers(a=100, b=4)
                .oracle()
                .depends_on(event1, delay_seconds=2)
            )
            oracle2 = (
                computations_app.power(base=25, exponent=2)
                .oracle()
