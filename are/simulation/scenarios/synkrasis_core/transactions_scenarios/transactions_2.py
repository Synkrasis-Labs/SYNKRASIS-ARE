...
class CustomScenario(COREScenario):
    ...
    prompt: str | None = (
        "Create account 'A123', deposit 200, withdraw 100 and then retrieve its transaction history."
    )
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            oracle2 = (
                transactions_app.deposit(account_id="A123", amount=200)
                .oracle()
                .depends_on(oracle1, delay_seconds=2)
            )
            oracle3 = (
                transactions_app.withdraw(account_id="A123", amount=100)
                .oracle()
