...
class CustomScenario(COREScenario):
    ...
    prompt: str | None = (
        "Create accounts 'A123' and 'B456' in this order, then retrieve their transaction histories in the order they were created."
    )
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            oracle3 = (
                transactions_app.get_transaction_history(account_id="A123")
                .oracle()
                .depends_on(oracle2, delay_seconds=2)
            )
            oracle4 = (
                transactions_app.get_transaction_history(account_id="B456")
                .oracle()
