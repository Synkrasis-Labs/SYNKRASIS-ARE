...
class CustomScenario(COREScenario):
    ...
    prompt: str | None = (
        "Navigate to 'page2.html', then search for the text: 'Matt then discusses his former job,'."
    )
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            oracle2 = (
                web_browsing_app.find_text_in_page(
                    text="Matt then discusses his former job,"
                )
                .oracle()
