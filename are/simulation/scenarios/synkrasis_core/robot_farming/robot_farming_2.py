...
class CustomScenario(COREScenario):
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            oracle3 = (
                robot_farming_app.water_plant(plant_id="plant_A", liters=1.5)
                .oracle()
            ...
            oracle5 = (
                robot_farming_app.water_plant(plant_id="plant_C", liters=2.5)
                .oracle()
            ...
            oracle9 = (
                robot_farming_app.water_plant(plant_id="plant_B", liters=1.5)
                .oracle()
