...
class CustomScenario(COREScenario):
    ...
    prompt: str | None = (
        "Set a new configuration for 'auto-save' to 'enabled' under the 'system' category, then print it."
    )
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            oracle1 = (
                configurations_app.set_config("auto-save", "enabled", "system")
                .oracle()
                .depends_on(event1, delay_seconds=2)
            )
            oracle2 = (
                configurations_app.print_config("auto-save")
                .oracle()
