...
class CustomScenario(COREScenario):
    ...
    prompt: str | None = (
        "Set a new configuration for 'backup-frequency' to 'daily' in 'storage', update 'timeout' to '10 minutes', then print both settings in whatever order you like."
    )
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            oracle1 = (
                configurations_app.set_config("backup-frequency", "daily", "storage")
                .oracle()
                .depends_on(event1, delay_seconds=2)
            )
            oracle2 = (
                configurations_app.update_config("timeout", "10 minutes")
                .oracle()
                .depends_on(oracle1, delay_seconds=2)
            )
            oracle3 = (
                configurations_app.print_config("backup-frequency")
                .oracle()
