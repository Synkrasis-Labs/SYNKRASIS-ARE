...
class CustomScenario(COREScenario):
    ...
    prompt: str | None = (
        "C1: stale-seedbed - till/firm, keep moist for weed flush , remove weeds by pesticide, then plant soybeans set 38 cm rows, 5 cm depth, 10 cm spacing"
    )
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            e_moist = sensors.update_cache(sensor_id="C1_seedbed", data_dict={"moisture": 0.7}).oracle().depends_on(info, delay_seconds=1)
