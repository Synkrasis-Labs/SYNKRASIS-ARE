...
class RoboticArmScenario5(COREScenario):
    """Two-object shuffle with two acceptable endings."""
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            # Branch A: move_home()
            o12a = arm.move_home().oracle().depends_on(o11, delay_seconds=1)
...
if __name__ == "__main__":
    ...
    run_and_validate(RoboticArmScenario5())
