...
class CustomScenario(COREScenario):
    ...
    prompt: str | None = (
        "Create account 'A123', deposit 100, charge a fee of 50, and check the balance."
    )
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            oracle2 = (
                transactions_app.deposit(account_id="A123", amount=100)
                .oracle()
                .depends_on(oracle1, delay_seconds=2)
            )
            oracle3 = (
                transactions_app.charge_fee(account_id="A123", amount=50)
                .oracle()
