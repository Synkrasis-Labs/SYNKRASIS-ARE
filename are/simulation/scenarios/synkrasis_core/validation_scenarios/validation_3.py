...
class CustomScenario(COREScenario):
    ...
    prompt: str | None = (
        "Validate if 'John_Doe' is a proper username, then hash the password 'MyStrongPass!'."
    )
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            oracle1 = (
                validation_app.validate_username(username="John_Doe")
                .oracle()
                .depends_on(event1, delay_seconds=2)
            )
            oracle2 = (
                validation_app.hash_password(password="MyStrongPass!")
                .oracle()
