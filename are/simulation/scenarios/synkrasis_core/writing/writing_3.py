...
class CustomScenario(COREScenario):
    ...
    prompt: str | None = (
        "Form a sentence about 'a fast bird' that 'flies beside the house'."
    )
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            oracle2 = (
                writing_app.add_adjective(adjective="fast")
                .oracle()
                .depends_on(oracle1, delay_seconds=2)
            )
            oracle3 = (
                writing_app.add_noun(noun="bird")
                .oracle()
                .depends_on(oracle2, delay_seconds=2)
            )
            oracle4 = (
                writing_app.add_verb(verb="flies")
                .oracle()
                .depends_on(oracle3, delay_seconds=2)
            )
            oracle5 = (
                writing_app.add_preposition(preposition="beside")
                .oracle()
            ...
            oracle7 = (
                writing_app.add_noun(noun="house")
                .oracle()
